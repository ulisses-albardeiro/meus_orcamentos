...
class Message
{
    ...
    public function mensagemErro(string $mensagem): Message
    {
    ...
    public function mensagemAtencao(string $mensagem): Message
    {
    ...
    public function modal(string $headerModal, string $mensagem, string $link = '#', string $linkTexto = 'Continuar'): Message
    {
        $this->css = 'modal';
